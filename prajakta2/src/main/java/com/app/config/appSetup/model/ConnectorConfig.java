...
public class ConnectorConfig implements ConnectorConfigInterface {
	...
	public ConnectorConfig(String serverId, String serverName, String ipAddress, String portNo, String databaseName, String userName, String password, Integer connectorType,
			String protocol, String filePath) {
		super();
	...
	public String toString() {
		return "ConnectorConfig [serverId=" + serverId + ", serverName=" + serverName + ", ipAddress=" + ipAddress + ", portNo=" + portNo + ", databaseName=" + databaseName
				+ ", userName=" + userName + ", password=" + password + ", connectorType=" + connectorType + ", protocol=" + protocol + ", filePath=" + filePath + "]";
	}
