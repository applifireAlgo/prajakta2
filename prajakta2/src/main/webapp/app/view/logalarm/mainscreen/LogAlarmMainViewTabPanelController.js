 ...
 * 
 */
Ext.define('Prajakta2.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.logAlarmMainViewTabPanelController',
	
	init : function()
	{
		var component = Ext.create("Prajakta2.view.logalarm.mainscreen.AddLogAlarm", {
			title : "",
		});
