 ...
 * 
 */
Ext.define('Prajakta2.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Prajakta2.view.logalarm.mainscreen.AddLogAlarmController',
			'Prajakta2.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Prajakta2.view.logalarm.mainscreen.AppAlarmPanel',
