 ...
 * 
 */
Ext.define("Prajakta2.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Prajakta2.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
