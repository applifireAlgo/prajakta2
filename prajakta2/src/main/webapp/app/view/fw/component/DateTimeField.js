 ...
 */
Ext.define('Prajakta2.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Prajakta2.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Prajakta2.view.fw.component.DateTimePicker(o);
    },
