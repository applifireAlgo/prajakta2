Ext.define('Prajakta2.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Prajakta2.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Prajakta2.view.console.ConsoleWindow');
