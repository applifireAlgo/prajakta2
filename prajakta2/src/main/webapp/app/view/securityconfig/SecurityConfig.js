 ...
 * 
 */
Ext.define('Prajakta2.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Prajakta2.view.securityconfig.SecurityConfigController',
			'Prajakta2.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
