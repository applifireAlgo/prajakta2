Ext.define('Prajakta2.view.desktop.design.drawer.main.MainPanelController', {
    ...
    onMyProfileClick : function()
    {
         ...
         this.pushViewInMainTab( "Prajakta2.view.usermanagement.enduser.UserProfile","My Profile","menuAction","Prajakta2.view.usermanagement.enduser.UserProfile");
    },
    
    onChangePwdClick:function()
    {
      
         this.pushViewInMainTab( "Prajakta2.view.usermanagement.enduser.ChangePwd","Change Password","menuAction","Prajakta2.view.usermanagement.enduser.ChangePwd");
    },
     onCloudClick : function()
    {
        
        this.pushViewInMainTab("Prajakta2.view.clouddrive.CloudDrive","Cloud Drive","menuAction","Prajakta2.view.clouddrive.CloudDrive");
    },
