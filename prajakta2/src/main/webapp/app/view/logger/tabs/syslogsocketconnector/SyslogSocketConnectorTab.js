 ...
 * 
 */
Ext.define('Prajakta2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Prajakta2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
