...
Ext
		.define(
				'Prajakta2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
				{
					...
					requires : [ 'Prajakta2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTabController' ],
