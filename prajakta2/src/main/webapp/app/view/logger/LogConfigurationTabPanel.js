...
Ext
		.define(
				'Prajakta2.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Prajakta2.view.logger.tabs.details.DetailsTab',
							'Prajakta2.view.logger.tabs.fileconnector.FileConnectorTab',
							'Prajakta2.view.logger.tabs.dbconnector.DBConnectorTab',
							'Prajakta2.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Prajakta2.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Prajakta2.view.logger.LogConfigurationTabPanelController',
