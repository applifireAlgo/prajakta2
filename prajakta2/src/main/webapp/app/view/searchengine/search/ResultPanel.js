Ext
		.define(
				'Prajakta2.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Prajakta2.view.searchengine.search.SearchEngineMainPanelController','Prajakta2.view.searchengine.search.PanelHeaderField' ,'Prajakta2.view.searchengine.search.ReportGridView','Prajakta2.view.searchengine.search.ReportChartView','Prajakta2.view.searchengine.search.documentView','Prajakta2.view.searchengine.search.DouMeanView','Prajakta2.view.googlemaps.map.MapPanel'],
