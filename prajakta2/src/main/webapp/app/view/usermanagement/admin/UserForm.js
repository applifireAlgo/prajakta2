Ext.define('Prajakta2.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Prajakta2.view.usermanagement.admin.AddUserDetailsViewModel', 'Prajakta2.model.AddUserDataModel' ],
