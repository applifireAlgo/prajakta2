...
public class QuestionTestCase extends EntityTestCriteria {
    ...
    private Question createQuestion(Boolean isSave) throws Exception {
        ...
        question.setQuestionIcon("JeqAIgv5ehiBWqjZf2Sntqf5fjPG1XlFyDdBFWmtsWJxbJvvn5");
        question.setQuestionDetails("KoAZSnjiYa");
        question.setQuestion("srv34iPQNHruX67AWAA4yz9Cx9JRV30d6UiphYVwmVnGjSyJe1");
    ...
    public void test2Update() {
        try {
            ...
            question.setQuestionIcon("0woKDDz59FX0vSQnjUrbgfceRJ37wzbkwVUIhK5lPzc4fzJdxD");
            question.setVersionId(1);
            question.setQuestionDetails("jVW6QjSiP6");
            question.setQuestion("RlREmhE7t2oBcJdH2uTDhWNaOH3kOqAopXaaFmm3Z7wsjqqvIw");
    ...
    private List<EntityTestCriteria> addingListOfFieldForNegativeTesting() {
        ...
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 2, "levelid", 21));
        entityContraints.add(new EntityTestCriteria(NOT_NULL, 3, "question", null));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 4, "question", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 5, "questionDetails", ""));
        entityContraints.add(new EntityTestCriteria(MIN_MAX, 6, "questionIcon", "4A45IYplJT6PBoMI4PpR9amYUOMaTTpGPtyJ3WNRGbYp98sFXSTbVwEZxedsg7Z0n"));
